...
def set_logger(args):
    ...
    if args.do_train:
        log_file = os.path.join(args.save_path or args.init_checkpoint, now + 'train' + args.model + '.log')
    else:
        log_file = os.path.join(args.save_path or args.init_checkpoint, now + 'test' + args.model + '.log')
