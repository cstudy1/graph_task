...
from utils import *
from model import train_step, test_step, TransE, ConvE,RotatE
 # ConvKB, RotatE
...
python code/main.py -model RotatE --cuda --data_path data/FB15k-237 --do_train True --do_valid True --do_test 1

python code/main.py -model TransE --cuda --data_path data/FB15k-237 --do_train True --do_valid True --do_test 1


python code/main.py -model ConvE --cuda --data_path data/FB15k-237 --do_train True --do_valid True --do_test 1
